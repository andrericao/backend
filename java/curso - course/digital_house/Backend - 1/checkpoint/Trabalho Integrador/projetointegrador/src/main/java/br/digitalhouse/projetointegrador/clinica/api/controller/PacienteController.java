package br.digitalhouse.projetointegrador.clinica.api.controller;

import br.digitalhouse.projetointegrador.clinica.api.dto.request.PacienteRequest;
import br.digitalhouse.projetointegrador.clinica.api.dto.response.ContatoResponse;
import br.digitalhouse.projetointegrador.clinica.api.dto.response.EnderecoResponse;
import br.digitalhouse.projetointegrador.clinica.api.dto.response.List.PacienteListResponse;
import br.digitalhouse.projetointegrador.clinica.api.dto.response.PacienteResponse;
import br.digitalhouse.projetointegrador.clinica.api.dto.response.Wrapper.PacienteWrapperResponse;
import br.digitalhouse.projetointegrador.clinica.domain.entity.Contato;
import br.digitalhouse.projetointegrador.clinica.domain.entity.Endereco;
